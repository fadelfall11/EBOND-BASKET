    ...
    public function run(): void
    {
        ...
        $actualites = [
            [
                ...
                'image' => $images->get(0)?->getFilename() ? ('actualites/' . $images->get(0)->getFilename()) : null,
            ...
            [
                ...
                'image' => $images->get(1)?->getFilename() ? ('actualites/' . $images->get(1)->getFilename()) : null,
            ...
            [
                ...
                'image' => $images->get(2)?->getFilename() ? ('actualites/' . $images->get(2)->getFilename()) : null,
