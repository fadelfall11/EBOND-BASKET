...
class JoueurSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $joueurs = [
            ...
            ['prenom' => 'Papa Idy Omar', 'nom' => 'Sy', 'poste' => 'Pivot', 'categorie_id' => $minimesGarcons->id, 'numero' => 4, 'capitaine' => true, 'photo' => 'joueurs/OMAR SY.jpeg', 'photo_position' => '50% 45%', 'eloges' => 'Grand et solide, il sécurise la raquette et apporte une présence importante au rebond.'],
