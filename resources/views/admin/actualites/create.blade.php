    ...
    <div class="container">
        <div style="max-width: 900px; margin: 0 auto;">
            <div style="display:flex; align-items:center; justify-content:space-between; gap:1rem; flex-wrap:wrap; margin-bottom:2rem;">
                <div>
                    <h2 class="section-title" style="margin-bottom:0.25rem;">Ajouter une actualité</h2>
                    ...
                    <form method="POST" action="{{ route('admin.actualites.store') }}" enctype="multipart/form-data">
                        ...
                        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:1rem;">
                            <div class="form-group">
                                ...
                                <input class="form-input" name="titre" value="{{ old('titre') }}" required>
                                @error('titre')<div class="form-error">{{ $message }}</div>@enderror
                            </div>
                            <div class="form-group">
                                <label class="form-label">Auteur</label>
                                <input class="form-input" name="auteur" value="{{ old('auteur') }}">
                        ...
                        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:1rem;">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-input" name="date_publication" value="{{ old('date_publication') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-input" name="contenu" rows="10" required>{{ old('contenu') }}</textarea>
